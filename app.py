...
FULL_SYLLABUS = {
    "Statistics": {
        "Modules": {
            ...
            "MODULE 3: DISTRIBUTIONS (2 marks)": "Uniform, Bernoulli, Binomial, Poisson, Normal, etc.",
    ...
    "Economics": {
        "Modules": {
            ...
            "Module II-VII": "Macro, Fiscal, Development, Kerala Economy, Econometrics."
        }
    }
}
...
if st.session_state.page == "home":
    ...
    for ex in ["Research Officer", "HSST Stat", "CSIR NET"]:
        if st.button(ex, use_container_width=True): navigate_to("exam_detail", exam=ex)
    ...
    for s in ["Statistics", "Economics", "Mathematics", "Commerce"]:
        if st.button(s, use_container_width=True): navigate_to("subject_options", subject=s)
    ...
    st.info("ക്വിസ് സെക്ഷൻ ലോഡ് ചെയ്യുന്നു...")
    # ഇവിടെയാണ് ക്വിസ് ലോജിക് വരുന്നത്
